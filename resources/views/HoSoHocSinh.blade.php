...
<body id="page-top">
  ...
  <div id="wrapper">
        ...
        <div class="container-fluid">
          ...
          <div style="height: 50px;">
            <div style="float: left;">
              <h5> 4.1.1 Nhập hồ sơ học sinh </h5>
            </div>
              ...
              <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="col"  style="margin-bottom: 10px">
                      ...
                      <script type="text/javascript">
                        var HuyenData = {!! json_encode($bieumau->huyen) !!};
                        HuyenData.size = 713;
                      </script>
                  ...
                  <div class="col" style="margin-bottom: 10px">
                    ...
                    <input type="text" class="form-control" style="width: 13rem; float: right; margin-right: 10px" name="xa">
                  ...
                  <div class="col" style="margin-bottom: 10px">
                    ...
                    <div id="noteNgaysinh" style="display: none; width: 13rem; float: right; margin-right: 10px">
                      <i class="fas fa-exclamation-triangle" style="color: red"></i>
                      <span style="color: red">Vui lòng điền ngày sinh học sinh.</span>
                    </div>
                  </div>
                  <div class="col" style="margin-bottom: 10px">
                  ...
                  <div class="tab-pane fade show active" id="thongtincanhan" role="tabpanel" aria-labelledby="thongtincanhan-tab">
                    ...
                    <div class="col" style="margin-bottom: 10px">
                      ...
                      <select class="form-control" style="width: 13rem; float: right; margin-right: 10px" name="loaikhuyettat">
                        @foreach($bieumau->khuyettat as $KT)
                        @if($loop->iteration > 3)
                        <option>{{$KT["C"]}}</option>
                        @endif
                        @endforeach
    ...
    <button type="button" name="modalThemVoiExcel" class="btn btn-dark" data-toggle="modal" data-target=".them-excel" style="background-color: black">Thêm với Excel</button>
      ...
      <div class="modal fade them-excel" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <form action="{{route('nhapexcelHSHS')}}" method="POST" enctype="multipart/form-data">
      @csrf
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
           <div class="modal-header">
            <h5 class="modal-title" id="Title">Thêm Hồ sơ học sinh với Excel</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
  ...
  <button type="button" class="btn btn-dark" name="btnXoa" data-toggle="modal" data-target=".xoa-modal" style="background-color: black">Xóa học sinh</button>
